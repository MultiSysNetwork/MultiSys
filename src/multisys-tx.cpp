...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MultiSys multisys-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  multisys-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded multisys transaction") + "\n" +
                               "  multisys-tx [options] -create [commands]   " + _("Create hex-encoded multisys transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded multisys transaction
