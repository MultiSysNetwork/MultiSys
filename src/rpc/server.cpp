...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MYUS features */
        {"multisys", "listmasternodes", &listmasternodes, true },
        {"multisys", "getmasternodecount", &getmasternodecount, true },
        {"multisys", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"multisys", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"multisys", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"multisys", "masternodecurrent", &masternodecurrent, true },
        {"multisys", "startmasternode", &startmasternode, true },
        {"multisys", "createmasternodekey", &createmasternodekey, true },
        {"multisys", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"multisys", "listmasternodeconf", &listmasternodeconf, true },
        {"multisys", "getmasternodestatus", &getmasternodestatus, true },
        {"multisys", "getmasternodewinners", &getmasternodewinners, true },
        {"multisys", "getmasternodescores", &getmasternodescores, true },
        {"multisys", "preparebudget", &preparebudget, true },
        {"multisys", "submitbudget", &submitbudget, true },
        {"multisys", "mnbudgetvote", &mnbudgetvote, true },
        {"multisys", "getbudgetvotes", &getbudgetvotes, true },
        {"multisys", "getnextsuperblock", &getnextsuperblock, true },
        {"multisys", "getbudgetprojection", &getbudgetprojection, true },
        {"multisys", "getbudgetinfo", &getbudgetinfo, true },
        {"multisys", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"multisys", "mnfinalbudget", &mnfinalbudget, true },
        {"multisys", "checkbudgets", &checkbudgets, true },
        {"multisys", "mnsync", &mnsync, true },
        {"multisys", "spork", &spork, true },
        ...
        {"zerocoin", "getzmyusseed", &getzmyusseed, false },
        {"zerocoin", "setzmyusseed", &setzmyusseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzmyus", &searchdzmyus, false },
        {"zerocoin", "dzmyusstate", &dzmyusstate, false },
...
{
    return "> multisys-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10101/\n";
}
