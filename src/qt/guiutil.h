...
// Copyright (c) 2017-2020 The PIXV developers
...
/** Utility functions used by the MultiSys Qt UI.
 */
namespace GUIUtil
{
...
// Render MYUS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmyus = false);
...
// Parse "multisys:" URI into recipient object, return true on successful parsing
