...
QString BitcoinUnits::id(int unit)
{
    ...
    case PIV:
        return QString("MYUS");
    case mPIV:
        return QString("mMYUS");
    case uPIV:
        return QString::fromUtf8("uMYUS");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZmyus)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMYUS)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZMYUS);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMYUS)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZMYUS));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
