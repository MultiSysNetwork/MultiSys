...
#ifndef MULTISYS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MULTISYS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MULTISYS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
