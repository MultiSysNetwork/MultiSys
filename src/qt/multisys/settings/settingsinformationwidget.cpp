...
#include "qt/multisys/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(MULTISYSGUI* _window,QWidget *parent) :
