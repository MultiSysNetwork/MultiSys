...
#include "qt/multisys/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/multisys/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MULTISYSGUI* _window, QWidget *parent) :
