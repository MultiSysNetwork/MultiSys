...
#include "qt/multisys/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/multisys/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(MULTISYSGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &MULTISYSGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
