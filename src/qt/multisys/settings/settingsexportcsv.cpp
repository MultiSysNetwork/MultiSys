...
#include "qt/multisys/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(MULTISYSGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("MultiSys_tx_csv_export(*.csv)") : tr("MultiSys_addresses_csv_export(*.csv)"),
                                        nullptr);
