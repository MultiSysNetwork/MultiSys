...
#include "qt/multisys/settings/settingsnetworkwidget.h"
#include "qt/multisys/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/multisys/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MULTISYSGUI* _window, QWidget *parent) :
