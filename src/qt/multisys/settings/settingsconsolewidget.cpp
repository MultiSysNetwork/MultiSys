...
#include "qt/multisys/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/multisys/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MULTISYSGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("<u>Welcome to the MYUS RPC console.</u>") + "<br>" +
