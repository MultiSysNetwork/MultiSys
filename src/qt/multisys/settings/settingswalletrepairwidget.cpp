...
#include "qt/multisys/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/multisys/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MULTISYSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MULTISYSGUI::handleRestart()
