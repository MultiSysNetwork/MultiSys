...
#include "qt/multisys/furabstractlistitemdelegate.h"
#include "qt/multisys/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/multisys/txviewholder.h"
...
#include "config/multisys-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(MULTISYSGUI* _window);
    ~DashboardWidget();
