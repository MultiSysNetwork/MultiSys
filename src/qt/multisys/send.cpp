...
#include "qt/multisys/forms/ui_send.h"
#include "qt/multisys/addnewcontactdialog.h"
#include "qt/multisys/qtutils.h"
#include "qt/multisys/sendchangeaddressdialog.h"
#include "qt/multisys/optionbutton.h"
#include "qt/multisys/sendconfirmdialog.h"
#include "qt/multisys/myaddressrow.h"
#include "qt/multisys/guitransactionsutils.h"
...
SendWidget::SendWidget(MULTISYSGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
