...
#include "qt/multisys/sendcustomfeedialog.h"
#include "qt/multisys/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MULTISYSGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MULTISYSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
