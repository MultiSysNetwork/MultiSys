...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MULTISYSGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, MULTISYSGUI* gui, double posX = 3);
