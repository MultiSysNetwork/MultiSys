...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeMultiSysAmount") || reset)
        SoftSetArg("-anonymizemultisysamount", settings.value("nAnonymizeMultiSysAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in multisys.cpp during shotdown to also remove the window positions
