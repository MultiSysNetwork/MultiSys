...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MULTISYSGUI* window = static_cast<MULTISYSGUI*>(parentWidget());
...
{
    MULTISYSGUI* gui = static_cast<MULTISYSGUI*>(parentWidget());
...
{
    hide();
    static_cast<MULTISYSGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MultiSys will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MYUSs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
