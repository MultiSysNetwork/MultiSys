...
#ifndef MULTISYS_STAKEINPUT_H
#define MULTISYS_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZMYUS() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CMyusStake : public CStakeInput
{
private:
...
public:
    ...
    bool IsZMYUS() const override { return false; }
    bool ContextCheck(int nHeight, uint32_t nTime) override;
};


#endif //MULTISYS_STAKEINPUT_H
