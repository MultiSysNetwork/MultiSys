...
#define __PORT_MAINNET__ 10100
#define __PORT_TESTNET__ 20100
#define __PORT_REGTEST__ 30100
 ...
 * MultiSys system. There are three: the main network on which people trade goods
