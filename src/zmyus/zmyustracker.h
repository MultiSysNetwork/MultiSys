...
#ifndef MULTISYS_ZMYUSTRACKER_H
#define MULTISYS_ZMYUSTRACKER_H
...
public:
    CzMYUSTracker(CWallet* parent);
    ~CzMYUSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMYUSWallet* zMYUSWallet = NULL);
