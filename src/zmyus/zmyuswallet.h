...
#ifndef MULTISYS_ZMYUSWALLET_H
#define MULTISYS_ZMYUSWALLET_H
...
public:
    ...
    void GenerateDeterministicZMYUS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMYUS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
