...
#define MyAppName "MultiSys"
#define MyAppPublisher "2022 MultiSys developers"
#define MyAppURL "https://myus-coin.com/"
#define MyAppExeName "multisys-qt.exe"
//#define MyAppExtraData "https://blocks.myus-coin.com/bootstraps/MYUS/bootstrap.zip"
...
DefaultDirName={autopf}\MultiSys
...
OutputDir=.\output
OutputBaseFilename=MultiSysSetup
...
DefaultGroupName=MultiSys Core
...
[Files]
Source: ".\package\multisys-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\MultiSys\MultiSys-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\MultiSys\MultiSys-Qt,strDataDir|{userappdata}\MultiSys\}');
  Result := True;
end;
