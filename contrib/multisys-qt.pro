...
RESOURCES += src/qt/multisys.qrc src/qt/multisys_locale.qrc

TRANSLATIONS += src/qt/locale/multisys_bg.ts \
                src/qt/locale/multisys_de.ts \
                src/qt/locale/multisys_en.ts \
                src/qt/locale/multisys_es.ts \
                src/qt/locale/multisys_fi.ts \
                src/qt/locale/multisys_fr.ts \
                src/qt/locale/multisys_it.ts \
                src/qt/locale/multisys_ja.ts \
                src/qt/locale/multisys_pl.ts \
                src/qt/locale/multisys_pt.ts \
                src/qt/locale/multisys_ru.ts \
                src/qt/locale/multisys_sk.ts \
                src/qt/locale/multisys_sv.ts \
                src/qt/locale/multisys_vi.ts \
                src/qt/locale/multisys_zh_CN.ts \
                src/qt/locale/multisys_zh_TW.ts
