...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='multisys.conf'
CONFIGFOLDER='/root/.multisys'
COIN_DAEMON='multisysd'
COIN_CLI='multisys-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/MultiSysNetwork/MultiSys/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
